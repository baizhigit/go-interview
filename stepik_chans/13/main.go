// Напишите функцию ConcurrentSortHead, которая из files ридеров,
// которые содержат упорядоченные по возрастанию строки,
// вернет m первых строк. Чтение из ридеров files должно быть конкурентным.
